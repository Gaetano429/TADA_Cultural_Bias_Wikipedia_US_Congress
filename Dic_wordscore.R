...
democrat_dictionary<-dictionary(list(democrat = c("government", "psychology", "cornell", "michigan", "american", 
                                                  ...
                                                  "ucc", "humanist", "agnostic", "applewood","atheist","believe","beth",
                                                  "brethren","christianity","christianity","chair","church",
...
congress_wordscore<-merge(congress_dfm_democrat,congress_dfm_republican)
